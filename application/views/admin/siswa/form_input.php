...
<?php 
echo form_open('admin/do_upload_siswa');
 ?>
 <table class="table table-bordered">
 	...
 	<tr><td width="130">Jurusan</td>
 			...
 			<td><div class="col-sm-6 col-sm-offset-6"><input type="text" name="jurusan" class="form-control" placeholder="Jurusan" value="" required></input></div></td>
 		</div></td>
 	</tr>
